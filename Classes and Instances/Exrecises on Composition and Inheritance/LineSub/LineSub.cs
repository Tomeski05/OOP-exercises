...
namespace Exrecises_on_Composition_and_Inheritance
{
    public class LineSub: Point
    {
        ...
        //{
        //    return (int)(Math.Sqrt(Math.Pow(this.end.getX() - this.getX(), 2) + Math.Pow(this.end.getY() - this.getY(), 2)));
        //}
        //public double getGradient()
        //{
        //    return (double)((this.end.getY() - this.getY(), this.end.getX() - this.getX()));
        //}
